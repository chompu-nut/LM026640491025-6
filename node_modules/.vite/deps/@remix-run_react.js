...
function PrefetchPageLinksImpl({
  ...
  let dataHrefs = React6.useMemo(() => getDataLinkHrefs(page, newMatchesForData, manifest), [newMatchesForData, page, manifest]);
  ...
  if (!future.unstable_singleFetch) {
    linksToRender = dataHrefs.map((href) => React6.createElement("link", _extends({
      key: href,
      rel: "prefetch",
      as: "fetch",
      href
    ...
    if (url.searchParams.get("_routes") !== "") {
      linksToRender = React6.createElement("link", _extends({
  ...
  return React6.createElement(React6.Fragment, null, linksToRender, moduleHrefs.map((href) => React6.createElement("link", _extends({
    key: href,
    rel: "modulepreload",
    href
